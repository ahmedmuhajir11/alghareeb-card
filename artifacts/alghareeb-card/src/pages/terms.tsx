...
export default function TermsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 py-6" dir={isRtl ? 'rtl' : 'ltr'}>
      <Helmet>
        <title>الشروط والأحكام | الغريب كارد</title>
        <meta name="description" content="الشروط والأحكام لاستخدام موقع الغريب كارد لشحن الألعاب والتطبيقات وتحويل الأموال." />
        <meta property="og:title" content="الشروط والأحكام | الغريب كارد" />
        <meta property="og:url" content="https://alghareebcard.com/terms" />
        <link rel="canonical" href="https://alghareebcard.com/terms" />
