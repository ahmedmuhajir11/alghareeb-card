...
// Auto-seed: ensure default currencies exist (always runs, ON CONFLICT DO NOTHING = safe)
(async () => {
  try {
...
// Admin: all currencies including inactive (no auth — reading currencies is not sensitive)
